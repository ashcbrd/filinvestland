...
const Zoho = ({
  ...
  useEffect(() => {
    ...
    let code = `var $zoho=$zoho || {};$zoho.salesiq = $zoho.salesiq || {widgetcode: "${process.env.NEXT_PUBLIC_ASPIRE_ZOHO_BOT_WIDGET_CODE}", values:{},ready:function(){}};var d=document;s=d.createElement("script");s.type="text/javascript";s.id="zsiqscript";s.defer=true;s.src="https://salesiq.zoho.com/widget";t=d.getElementsByTagName("script")[0];t.parentNode.insertBefore(s,t);`;
    ...
    const interval = setInterval(async () => {
      ...
      item?.[0]?.setAttribute(
        "style",
        "width:270px !important; height:84px !important; margin-right:40px !important; cursor:pointer;"
      );
