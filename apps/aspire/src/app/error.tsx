...
const error = ({ error, reset }: { error: Error; reset: () => void }) => {
  ...
  return (
    <div className="fixed left-0 top-0 z-[99999] flex h-screen w-screen items-center justify-center bg-white">
      <div className="flex h-max w-[600px] flex-col items-center gap-y-10">
        <div className="flex flex-col gap-y-6">
          <h1 className="text-center text-4xl font-bold">
            Oops! Something Went Wrong.
          </h1>
          <p className="mx-auto flex w-max items-center gap-x-2 bg-red-200 !py-1 pl-2 pr-3 text-center text-sm text-red-500">
            <svg
              width="20"
              height="20"
              viewBox="0 0 24 24"
        ...
        <p className="text-center text-sm">
          ...
          out to our{" "}
          <a
            className="text-aqua-blue hover:cursor-pointer hover:underline"
