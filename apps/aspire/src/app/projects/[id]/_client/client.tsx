    ...
    <Page id="project" disableHeader={isSticky}>
      ...
      {content.productOffering.oferrings.length > 0 && (
        ...
        >
          ...
          {content.productOffering.oferrings.length > 0 && (
            <div className="mx-[-30px] flex flex-wrap md:w-full md:flex-col">
              {content.productOffering.oferrings.map((o: any) => (
                <div className="w-3/6 px-[30px] md:w-full md:pb-[30px]">
                  <div>
                    ...
                    <div className="flex xs:flex-wrap">
                      {o.title && (
                        <h4 className="mr-[49px] max-w-[175px] flex-shrink-0 leading-[1.2]">
                          {o.title}
                        </h4>
                      )}
                      {o.Specification.length > 0 && (
                        <div
                          className={`${!o.title ? "!w-full" : ""} xs:w-full`}
                        >
      ...
      {console.log(content.siteDevelopmentPlan.developmentPlanRichText)}
          ...
          <div className="flex items-center tablet:flex-col">
            ...
            {content.siteDevelopmentPlan.floorPlanImages.length > 0 && (
              <div className="w-full max-w-[580px] flex-shrink-0 tablet:max-w-full">
                {content.siteDevelopmentPlan.floorPlanImages.map((img: any) => (
