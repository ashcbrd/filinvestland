...
import qs from "qs";
import Client from "../blog/client/Client";
...
async function getData(searchParams: any) {
  const query = qs.stringify({
      where: {
          ...
          ...(searchParams.keyword ? { title: { like: searchParams.keyword } } : {}),
          ...(searchParams.location ? { location: { equals: searchParams.location } } : {}),
          ...(searchParams.propertyType ? { propertyType: { equals: searchParams.propertyType } } : {}),
          ...(searchParams.province ? { location: { equals: searchParams.province } } : {}),
          ...(searchParams.city ? { subLocationTwo: { equals: searchParams.city } } : {}),
